            ...
            <div className="md:w-1/2 space-y-6 animate-fade-in">
              <div className="space-y-3">
                <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white">
                  Hi, I'm <span className="heading-gradient relative inline-block">
                    John Doe
        ...
        <div className="section-container">
          ...
          <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="glass p-6 animate-on-scroll opacity-0 transform transition-all duration-500 hover:scale-105 hover:shadow-[0_5px_20px_rgba(157,70,255,0.15)]">
              ...
              <p className="text-white mb-4">Building beautiful, responsive UIs with modern frameworks</p>
            ...
            <div className="glass p-6 animate-on-scroll opacity-0 transform transition-all duration-500 hover:scale-105 hover:shadow-[0_5px_20px_rgba(157,70,255,0.15)]">
              ...
              <p className="text-white mb-4">Creating robust APIs and server-side applications</p>
              <div className="flex flex-wrap gap-2">
            ...
            <div className="glass p-6 animate-on-scroll opacity-0 transform transition-all duration-500 hover:scale-105 hover:shadow-[0_5px_20px_rgba(157,70,255,0.15)]">
              ...
              <p className="text-white mb-4">Deploying and maintaining applications in the cloud</p>
              <div className="flex flex-wrap gap-2">
